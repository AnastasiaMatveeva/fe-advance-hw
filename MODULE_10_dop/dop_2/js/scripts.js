...
startBtn.addEventListener("click", countDownFrom.bind(1,1));
...
// // - создаем нужное время путем добаления к текущему 1 минуты
// - пишем функцию setInterval.Там обьявляем условие, что если(в данном случае "пока")
// текщее больше равно заданного - идет отсчет.
// “timer.id использую вместо присвоения переменной”
